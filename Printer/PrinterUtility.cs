...
namespace Quanto.Printer
{
    public class RawPrinterHelper
    {
        ...
        public static PageSettings DefaultPortraitSetting
        {
            get
            {
        ...
        public static bool SendBytesToPrinter(IntPtr pBytes, Int32 dwCount)
        {
            ...
            //if (ApplicationContext.Current.PrinterSettings == null)
            //    return false;

            //string szPrinterName = ApplicationContext.Current.PrinterSettings.PrinterName;
            string szPrinterName = "Thermal Printer";
            ...
            di.pDocName = "Clinical Plus document";
            di.pDataType = "RAW";
        ...
        public static bool SendStringToPrinter(string szString)
        {
            ...
            //    {
            //        ApplicationContext.Current.PrinterSettings = pd.PrinterSettings;
            //    }
            //    else
            //    {
            //        return false;
