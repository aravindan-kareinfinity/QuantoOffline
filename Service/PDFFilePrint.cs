...
namespace Quanto
{
    public class PrintPdf
    {
        ...
        {
            return SendFileToPrinter(System.IO.File.ReadAllBytes(pdfFileName));
        }

        public static string defaultprinter = null;
        public static bool SendFileToPrinter(byte[] data)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(defaultprinter) && GetDefaultPrinter(dp, ref size))
                {
